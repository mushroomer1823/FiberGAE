...
def trainingData():
    ...
    for folderpath in ["/data/hyf/atlas/val/A_6/", "/data/hyf/atlas/val/B_6", "/data/hyf/atlas/val/C_6", "/data/hyf/atlas/val/D_6", "/data/hyf/atlas/val/F_6"]:
    ...
    picklepath = "/data/hyf/swm/model4_data/test_5subjects.pickle"
