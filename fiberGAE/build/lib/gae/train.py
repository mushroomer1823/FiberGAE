...
flags = tf.app.flags
FLAGS = flags.FLAGS
flags.DEFINE_float('learning_rate', 0.05, 'Initial learning rate.') # default 0.01
flags.DEFINE_integer('epochs', 500, 'Number of epochs to train.') # default 200
...
flags.DEFINE_string('datapath', '/data/hyf/atlas/train/H_4/2000/', 'load data from')
...
embeddings = outs[-1]
print(embeddings)
savepath = datapath_str + "embeddings.pkl"
